...
The command creates a public `spmt.app.json`, a working `spmt/publish-event.mjs`, `.env.example`, and a `.gitignore` entry for `.env`. In Node projects it also installs `@spmt/sdk`.
