...
| Cosmo Commlink convergence | `docs/ecosystem/COSMO_COMMLINK_INTEGRATION_PLAN.md` | Capability-preserving plan for making Cosmo the `spmt.live` messaging experience without moving app-owned runtimes |
