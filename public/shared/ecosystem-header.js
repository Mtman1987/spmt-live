(() => {
  ...
  function installStyle() {
    ...
    style.textContent = `
      ...
      #spmt-ecosystem-header{position:fixed;inset:0 0 auto 0;z-index:2147483000;height:var(--spmt-ecosystem-header-height);display:flex;align-items:center;gap:8px;padding:5px 8px;border-bottom:1px solid rgba(255,255,255,.12);background:rgba(3,5,12,.94);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);box-shadow:0 6px 20px rgba(0,0,0,.3);font:800 10px/1.1 Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;letter-spacing:.035em;color:#d7dce8;pointer-events:none}
      #spmt-ecosystem-header .spmt-eco-brand{display:inline-flex;align-items:center;gap:6px;flex:0 0 auto;color:#fff;text-decoration:none;padding:0 3px;font-size:10px;letter-spacing:.08em;pointer-events:auto}.spmt-eco-brand:before{content:"";width:7px;height:7px;border-radius:999px;background:#34d399;box-shadow:0 0 9px #34d399}
      #spmt-ecosystem-header .spmt-eco-chips{display:flex;align-items:center;gap:5px;min-width:0;overflow-x:auto;overscroll-behavior-inline:contain;scrollbar-width:none;flex:1;pointer-events:none}#spmt-ecosystem-header .spmt-eco-chips::-webkit-scrollbar{display:none}
      #spmt-ecosystem-header .spmt-eco-chip,#spmt-ecosystem-header .spmt-eco-total{display:inline-flex;align-items:center;white-space:nowrap;border:1px solid rgba(255,255,255,.1);border-radius:999px;background:rgba(255,255,255,.04);color:#cfd5e2;text-decoration:none;padding:6px 8px;transition:background .15s ease,border-color .15s ease,color .15s ease;pointer-events:auto}#spmt-ecosystem-header .spmt-eco-chip:hover,#spmt-ecosystem-header .spmt-eco-total:hover{background:rgba(255,255,255,.09);color:#fff}
