...
if (source.includes(stateBefore)) source = source.replace(stateBefore, stateAfter);
...
if (source.includes(finishBefore)) source = source.replace(finishBefore, finishAfter);
...
if (source.includes(attachBefore)) source = source.replace(attachBefore, attachAfter);
