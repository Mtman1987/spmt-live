...
```powershell
npm exec --yes --package=https://spmt.live/sdk/spmt-sdk-0.1.2.tgz -- spmt install
```
...
```bash
npm exec --yes --package=https://spmt.live/sdk/spmt-sdk-0.1.2.tgz -- spmt event server.status --data-file status.json
```
