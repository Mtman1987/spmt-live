...
```powershell
npm exec --yes --package=https://spmt.live/sdk/spmt-sdk-0.2.0.tgz -- spmt install
```
...
```bash
npm exec --yes --package=https://spmt.live/sdk/spmt-sdk-0.2.0.tgz -- spmt event server.status --data-file status.json
```
